...
@interface UICircularSlider() <UIGestureRecognizerDelegate>
...
@implementation UICircularSlider {
    UIPanGestureRecognizer *volumePanGestureRecognizer;
}
...
- (void)setup {
	...
	volumePanGestureRecognizer = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(panGestureHappened:)];
	volumePanGestureRecognizer.maximumNumberOfTouches = volumePanGestureRecognizer.minimumNumberOfTouches;
    volumePanGestureRecognizer.delegate = self;
	[self addGestureRecognizer:volumePanGestureRecognizer];
}
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldReceiveTouch:(UITouch *)touch {
    ...
    if (volumePanGestureRecognizer == gestureRecognizer) {
        ...
        CGFloat dist = distanceBetweenTwoPoints(tapLocation, sliderCenter);
        CGFloat rad = ([self sliderRadius] - MAX(kLineWidth, kThumbRadius));
        if (dist < rad) {
            return NO;
        }
    }
